...
const contactLinks = [
  { icon: Mail, label: "Email", value: "johnvictorchavala95@gmail.com", href: "mailto:johnvictorchavala95@gmail.com", bg: "bg-violet/10", text: "text-violet", glow: "hover:glow-violet" },
  { icon: Phone, label: "Phone", value: "+91 8309240212", href: "tel:+918309240212", bg: "bg-pink/10", text: "text-pink", glow: "hover:glow-pink" },
  { icon: Github, label: "GitHub", value: "johnvictorchavala", href: "https://github.com/johnvictorchavala", bg: "bg-cyan/10", text: "text-cyan", glow: "hover:glow-cyan" },
  { icon: Linkedin, label: "LinkedIn", value: "john-victor-chavala", href: "https://www.linkedin.com/in/john-victor-chavala/", bg: "bg-lime/10", text: "text-lime", glow: "hover:glow-lime" },
];
